...
## Option locale H2 (sans DB2)

Une option de profil **local-h2** est ajoutée pour démarrer sans DB2, avec une base H2 en mémoire.

### Lancer en mode H2 local

```bash
export SPRING_PROFILES_ACTIVE=local-h2
mvn spring-boot:run
```
